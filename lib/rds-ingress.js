...
var Ingress = function(options) {
    ...
    self.DBSecurityGroupName = options.securitygroup || 'default';
...
Ingress.prototype.authorizeMe = function () {
    var self = this;
    console.log('authorizingSecurityGroupIngress (%s) for me',self.DBSecurityGroupName);
...
Ingress.prototype.authorizeCIDRIP = function (cidrip) {
    var self = this;
    console.log('authorizingSecurityGroupIngress (%s) for %s: ', self.DBSecurityGroupName, cidrip);
